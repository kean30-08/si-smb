                    ...
                    <form action="{{ route('pengajar.update', $pengajar->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div id="kredensialContainer"
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="email" name="email" id="emailInput"
                                            ...
                                            placeholder="Masukkan Email Aktif Pengajar">
                                        @error('email')
                                    ...
                                    <div>
                                        <label class="block font-medium text-sm text-gray-700">Password Login
                                            Baru</label>
                            ...
                            <div class="md:col-span-2 border-b pb-4 mt-2 mb-2">
                                <h3 class="text-lg font-bold text-gray-800">Biodata Pengajar</h3>
                            </div>
