                    ...
                    <form action="{{ route('agenda.store') }}" method="POST">
                        ...
                        <div class="mb-6 border-b pb-6">
                            ...
                            <input type="date" name="tanggal" value="{{ old('tanggal') }}"
                                class="block w-full md:w-1/3 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                required>
                        </div>
                        ...
                        <button type="button" onclick="addRundown()"
                            class="mt-2 mb-6 bg-blue-100 border border-blue-400 text-blue-600 hover:bg-blue-200 hover:text-blue-800 rounded-md py-2 px-4 text-sm font-semibold text-blue-600 hover:text-blue-800 flex items-center">
                        ...
                        <div class="flex items-center justify-end mt-6 border-t pt-4">
                            ...
                            <button type="submit"
                                class="bg-indigo-800 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded transition">
            ...
            const rowHtml = `
                <div class="rundown-item bg-gray-50 p-4 rounded-md border border-gray-200 mb-4 relative mt-4">
                    <button type="button" onclick="this.closest('.rundown-item').remove()" 
                        class="absolute top-3 right-3 bg-red-100 border border-red-400 text-red-600 hover:bg-red-200 hover:text-red-800 text-sm font-bold py-1 px-3 rounded flex items-center transition">
