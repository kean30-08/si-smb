                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('materi.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <label class="block font-medium text-sm text-gray-700">Deskripsi / Rangkuman Singkat
                                    (Opsional)</label>
                                <textarea name="deskripsi" rows="4" placeholder="Masukkan deskripsi atau rangkuman singkat materi..."
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 placeholder:italic">{{ old('deskripsi') }}</textarea>
                            </div>

                            {{-- Input Upload File Khusus Tailwind --}}
                            <div class="p-4 border border-dashed border-gray-300 rounded-md bg-gray-50">
                                <label class="block font-bold text-sm text-gray-800 mb-2">Upload File Materi
                                    (Opsional)</label>
                                <p class="text-xs text-gray-500 mb-3">Format yang didukung: PDF, DOCX, PPTX, XLSX, ZIP.
                                    Maksimal 5MB.</p>
