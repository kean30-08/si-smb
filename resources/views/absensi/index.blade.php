            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <form action="{{ route('absensi.index') }}" method="GET"
                        class="mb-6 flex flex-col lg:flex-row gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200 lg:items-end">
                        ...
                        {{-- TAMPILAN NAMA PIC ABSENSI HARI ITU --}}
                        @if ($agendas->isNotEmpty() && $penanggungJawab)
                            <div class="w-full lg:w-auto">
                                ...
                                <div
                                    ...
                                    <i data-lucide="user" class="w-6 h-6 px-0.5 mr-2"></i>
                        ...
                        <div class="flex-1 w-full lg:w-auto mt-2 lg:mt-0">
                            ...
                            <div class="flex">
                                ...
                                <button type="submit"
                                    class="bg-black hover:bg-gray-700 text-white px-4 py-2 rounded-r-md font-medium transition duration-150 flex items-center">
                        ...
                        @if (!empty($search))
                            <div class="flex justify-end w-full lg:w-auto">
                                <a href="{{ route('absensi.index', ['type' => $type, 'tanggal' => $tanggal, 'kelas_id' => $kelas_id]) }}"
                                    class="w-full lg:w-auto text-center bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md font-medium transition duration-150 border border-indigo-600">
                                    Reset
                                </a>
                            </div>
                        @endif
