<x-app-layout>
                        ...
                        <div
                            ...
                            <div class="p-5 flex flex-col flex-grow">
                                <p class="text-xs text-indigo-600 font-bold mb-2 uppercase tracking-wider">
                                    {{ \Carbon\Carbon::parse($pemberitahuan->created_at)->translatedFormat('d M Y') }}
                                </p>
    ...
    {{-- FOOTER KHUSUS VISITOR (GUEST) --}}
    @guest
        <div class="mt-12 bg-white border-t border-gray-200 py-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-indigo-50 rounded-2xl p-6 md:p-8 border border-indigo-100 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
                    
                    {{-- Informasi Kontak --}}
                    <div class="text-center md:text-left w-full md:w-auto">
                        <h3 class="text-xl font-extrabold text-indigo-900 mb-4">Informasi & Pendaftaran</h3>
                        
                        <div class="space-y-3">
                            <p class="text-sm text-gray-700 flex items-start md:items-center justify-center md:justify-start gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <span><strong>Alamat:</strong> Jln Melati No. 18, Tabanan, Bali</span>
                            </p>
                            
                            <p class="text-sm text-gray-700 flex items-center justify-center md:justify-start gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <span><strong>No. Telp / WA:</strong> +62 878-6320-8967</span>
                            </p>
                            ...
                            <p class="text-sm text-gray-700 flex items-center justify-center md:justify-start gap-2">
                                ...
                                <span><strong>Email:</strong> admin.smb.vdc@gmail.com</span>
                            </p>
                        </div>
                    </div>

                    {{-- Tombol Daftar CTA (Call to Action) --}}
                    <div class="w-full md:w-auto mt-2 md:mt-0">
                        {{-- SESUAIKAN NAMA ROUTE PENDAFTARAN DI BAWAH INI (contoh: pendaftaran.create atau daftar.create) --}}
                        <a href="{{ route('pendaftaran.create') }}" 
                            class="flex justify-center items-center gap-2 w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-lg py-4 px-8 rounded-xl shadow-lg transition-transform transform hover:scale-105 active:scale-95">
                            Klik Daftar Disini
                        ...
                        <p class="text-xs text-indigo-400 text-center mt-3 md:hidden">
                            Gunakan tombol di atas untuk mendaftarkan siswa baru.
                        </p>
                    </div>
